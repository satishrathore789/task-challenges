  ...
  <body>
    ...
    <div class="container">
        ...
        <div id="page-contents">
          <div class="row">
            <div class="col-md-3">
              ...
              <!--Edit Profile Menu-->
              <ul class="edit-menu">
              	<li class="active"><i class="icon ion-ios-information-outline"></i><a href="editprofile">Basic Information</a></li>
            ...
            <div class="col-md-7">
              ...
              <div class="edit-profile-container">
                ...
                <form:form action="edit"  method="POST"  modelAttribute="REG"  name="basic-info" id="basic-info" class="form-inline"> 
    
     <%--  <c:forEach items=" ${REG}" var="mydata">  --%>   <%--   value ="${mydata.firstName}" --%>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-xs-6">
                        ...
                        <form:input path="firstName" id="firstname"  class="form-control input-group-lg" type="text" name="firstname" title="Enter first name" />
                      </div>
                    ...
                    <div class="row">
                      <div class="form-group col-xs-6">
                        ...
                        <form:input path="middleName" id="firstname" class="form-control input-group-lg" type="text" name="middle" title="Enter middle name" placeholder="Middle name" />
                      </div>
                      <div class="form-group col-xs-6">
                      ...
                      <form:radiobutton path="gender" value="M"  name="optradio" />Male
                    ...
                    <div class="row">
                      <div class="form-group col-xs-6">
                        ...
                        <form:input path="email"  id="email" class="form-control input-group-lg" type="text" name="Email" title="Enter Email"   />
                      </div>
                      <div class="form-group col-xs-6">
                        <label for="website">Website</label>
                        <form:input path="webSite" id="website" class="form-control input-group-lg" type="text" name="firstname" title="Enter first name"   />
                      </div>
                    </div>
                      <div class="row">
                      <div class="form-group col-xs-6">
                        <label for="text">Office Contact Number</label>
                       <form:input path="phoneNumber" id="Officer" class="form-control input-group-lg" type="text" name="Office" title="Enter Office Contact Number" placeholder="Office Contact Number"  />
                      </div>
                       <div class="form-group col-xs-6">
                        <label for="text">Residential Contact Number</label>
                       <input type="text" id="Residential" class="form-control input-group-lg" type="text" name="Residential " title="Enter Residential Contact Number" placeholder="Residential Contact Number"  />
                      </div>
                  </div> 
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-xs-6">
                       ...
                       <div class="form-group col-xs-6">
                        ...
                        <form:input path="state"  id="city" class="form-control input-group-lg" type="text" name="state" title="Enter state" placeholder="Your state" />
                      </div>
                    </div>
                    ...
                    <div class="form-group col-xs-6">
                        <label for="city"> City</label>
                         <form:input path="city" id="city" class="form-control input-group-lg" type="text" name="city" title="Enter city" placeholder="Your city" />
                      </div>
                      
                       <div class="form-group col-xs-6">
                        <label for="city"> Zip code</label>
                       <form:input path="zipCode" class="form-control input-group-lg" type="text" name="Zip Code" title="Enter Zip Code" placeholder="Your Zip code" />
                      </div>
                      </div>
                   <div class="row">
     ...
     <%--    </c:forEach>   --%>
                ...
                <%--   <c:forEach items="${Profile}" var="mydata">
