            ...
            <div class="col-md-3">
              ...
              <ul class="edit-menu">
                ...
                <li><i class="icon ion-ios-settings"></i><a href="edit-profile-settings">Account Settings</a></li>
              	<li class="active"><i class="icon ion-ios-locked-outline"></i><a href="editprofilePassword">Change Password</a></li>
              </ul>
            </div>
            <div class="col-md-7">
              ...
              <div class="edit-profile-container">
                ...
                <from:form modelAttribute="PASS" method="POST" action="updatepassword" name="update-pass" id="education" class="form-inline">
                  
                    <div class="row">
                      <div class="form-group col-xs-12">
                        <label for="my-password">Old password</label>
                        <from:input  path="password"  id="my-password" class="form-control input-group-lg" type="password" name="password" title="Enter password" placeholder="Old password"/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-6">
                        <label>New password</label>
                        <from:input  path="password" class="form-control input-group-lg"  type="password" name="password" title="Enter password" placeholder="New password"/>
                      </div>
                      <div class="form-group col-xs-6">
                    ...
                    <button class="btn btn-primary" name="submit" value="submit">Update Password</button>
